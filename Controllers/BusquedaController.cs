...
using VN_Center.Models.Entities; // Necesario para las entidades
using Microsoft.AspNetCore.Identity; // Necesario para UserManager
using Microsoft.AspNetCore.Authorization; // Para [Authorize] si quieres proteger la búsqueda

namespace VN_Center.Controllers
{
  [Authorize] // Opcional: protege la búsqueda si es necesario
  public class BusquedaController : Controller
  {
    private readonly VNCenterDbContext _context;
    private readonly UserManager<UsuariosSistema> _userManager; // Para buscar usuarios
    ...
    {
      ViewData["TerminoBusquedaOriginal"] = terminoBusqueda; // Para mostrar en la vista
      ...
      if (!string.IsNullOrWhiteSpace(terminoBusqueda))
      {
        ...
        resultados.UsuariosEncontrados = await _userManager.Users
            ...
            .Take(15) // Limitar la cantidad de resultados por categoría
            .ToListAsync();
        ...
        resultados.BeneficiariosEncontrados = await _context.Beneficiarios
            ...
            .Include(b => b.Comunidad) // Incluir comunidad para mostrar en resultados si es necesario
            .Take(15)
            .ToListAsync();
        ...
        resultados.ProgramasEncontrados = await _context.ProgramasProyectosONG
            ...
            .Include(p => p.ResponsablePrincipalONG) // Incluir responsable para mostrar
            .Take(15)
            .ToListAsync();
        ...
        resultados.GruposEncontrados = await _context.GruposComunitarios
            ...
            .Include(g => g.Comunidad) // Incluir comunidad para mostrar
            .Take(15)
            .ToListAsync();
      }
